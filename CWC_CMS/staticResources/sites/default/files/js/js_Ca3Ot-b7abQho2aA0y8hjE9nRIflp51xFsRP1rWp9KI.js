...
(function ($) {
  Drupal.behaviors.MyCustomTheme = {
	...
	$( ".data-in li a" ).appendTo( "h1.heading1" );


 $('header .dropdown-menu li').addClass('fontSize');
...
jQuery(document).ready(function(){
	jQuery(".inner-right").find("a").each(function(){
...
var newurl=oldurl.replace(/%40/g,"@");
